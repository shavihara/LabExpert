...
import { Play, Pause, Square, Save, FolderOpen, Settings, Wifi, WifiOff, Download, Grid, Home, ZoomIn, ZoomOut } from 'lucide-react';
...
// Optionally, type for currentReading (can be DataPoint or partial)
type CurrentReading = {
  x: number;
  y: number;
  time?: string;
...
const LabExpertUI = () => {
  ...
  const [currentReading, setCurrentReading] = useState<CurrentReading>({ x: 0, y: 0 });
