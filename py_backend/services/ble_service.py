...
CHAR_USER = "0000FFF6-0000-1000-8000-00805F9B34FB"
...
class BLEService:
    ...
    async def provision(self, address: str, ssid: str, password: str, host_mac: Optional[str] = None, username: Optional[str] = None, status_cb: Optional[Callable[[str], None]] = None, timeout: float = 30.0) -> Dict:
        ...
        async with BleakClient(address) as client:
            ...
            if username:
                try:
                    await client.write_gatt_char(CHAR_USER, username.encode("utf-8"))
                except Exception:
                    pass
            if host_mac:
                try:
